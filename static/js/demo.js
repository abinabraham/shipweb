...
var DEMO =
{
	...
	InitializeScene : function InitializeScene() {
		...
		loader.load( '/static/models/BlackPearl/BlackPearl.obj', '/static/models/BlackPearl/BlackPearl.mtl', function ( object ) {
		...
		// Add rain
		{
			...
			this.ms_ImageLoader.load( '/static/img/water-drop.png', function ( image ) {
	...
	LoadMountains : function LoadSkyBox() {
		...
		this.ms_ImageLoader.load( '/static/img/																																																																																												mountains.png', function ( image ) {
	...
	UpdateEnvironment : function UpdateEnvironment( key ) {
		...
		var sources = [
			'/static/img/																																																																																												' + textureName + '_west' + textureExt,
			'/static/img/																																																																																												' + textureName + '_east' + textureExt,
			'/static/img/																																																																																												' + textureName + '_up' + textureExt,
			'/static/img/																																																																																												' + textureName + '_down' + textureExt,
			'/static/img/																																																																																												' + textureName + '_south' + textureExt,
			'/static/img/																																																																																												' + textureName + '_north' + textureExt
		];
		var images = [];
